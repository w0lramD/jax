...
def sharding_spec_sharding_proto(self, special_axes: Mapping[int, xc.OpSharding.Type] = {}):
  ...
  if replicated_maxes:
    last_tile_dims = []
    axes_by_type: Dict[xc.OpSharding.Type, List[MeshAxisName]] = {}
    size_by_type: Dict[xc.OpSharding.Type, int] = defaultdict(lambda: 1)
